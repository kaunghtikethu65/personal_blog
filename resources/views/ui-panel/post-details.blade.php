            ...
            <div class="col-md-12">
                ...
                <div class="header">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <img src="images/yms.jpg" id="header-img" alt="">
                        </div>
                        <div class="col-md-4">
                            <br>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="post-details">
                                ...
                                <br><br>
                                <h5><strong>WHERE ARE YOU NOW? I AM REALLY FANTASTIC AND GONNA TO OVERCOME IT</strong>
                                </h5>
                                <p style="text-align: justify;">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam neque vitae ab
                                    error, inventore ipsam minima maxime ratione veritatis molestiae. Nesciunt
                                    consectetur alias adipisci vitae! Rerum voluptas consequatur ipsam commodi. Lorem
                                    ipsum dolor sit amet consectetur adipisicing elit. Sed optio minima, aliquam placeat
                                    illum dolorem possimus rerum eveniet neque iusto. Saepe autem ducimus dolorem
                                    molestiae sequi eius veritatis laudantium sapiente.
                                </p>
                                <div>
                                    ...
                                    <button class="btn btn-sm btn-info comment" data-toggle="collapse"
                                ...
                                <div class="comment-form">
                                    <div class="collapse" id="collapseExample">
                                        ...
                                        <div class="comment-show">
                                            <img src="https://pluspng.com/img-png/user-png-icon-male-user-icon-512.png"
                                                alt="" width="30px"> John
                                        ...
                                        <div class="comment-show">
                                            <img src="https://pluspng.com/img-png/user-png-icon-male-user-icon-512.png"
                                                alt="" width="30px"> Jenifer
                                            <div class=" comment-box mt-2">
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum
                                                illum aspernatur quod non. Inventore natus dolorum autem dicta porro
                                                quis rem reprehenderit, magni harum corrupti nisi sequi ea omnis
                                                recusandae.
                                            </div>
                                        </div>
                                        <br>
